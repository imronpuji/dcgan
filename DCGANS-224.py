...
class DataPreprocessing:
    def __init__(self, image_size=224): # Changed image size from 128 to 224
...
def load_class_data(preprocessor, data_path, class_name, batch_size=64):  # Reduced batch size for 224x224
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train DCGANs for specific corn disease classes with 224x224 resolution.",
